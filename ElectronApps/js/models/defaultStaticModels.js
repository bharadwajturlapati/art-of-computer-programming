var $staticModels = {
	...
	createStaticDomNodesCache : function() {
		$staticModels.staticDomNodesCache["new-web-view-tab-node"] = $liveBrowserModels
				.addTab();
		$staticModels.staticDomNodesCache["new-web-view-tabcontent-node"] = $liveBrowserModels
				.addTabContent();
	}
}