 ...
 * Usage:
 *
 * JmsProducer -m queueManagerName -d destinationName [-h host -p port -l
 * channel] [-u user -w passWord]
 *
 * for example:
 *
...
public class JMSProducer80 {
	...
	private static void parseArgs(String[] args) {
		try {
			...
			// Whether the destination is a queue or a topic. Apply a simple
			// check.
	...
	private static void printUsage() {
		System.out.println("\nUsage:");
		System.out.println(
				"JmsProducer -m queueManagerName -d destinationName [-h host -p port -l channel] [-u userid -w passWord]");
		return;
	}
